  ...
  function init() {
    ...
    const db = [
     { s:"歷史", t:["國七","台灣史"], e:"長濱文化", y:"舊石器時代", p:"早期人類", k:"八仙洞", d:"台灣已知最早的史前文化，以敲打石器為主，已知用火" },
        ...
        { s:"歷史", t:["國七","台灣史"], e:"渡台禁令", y:"清領前期", p:"康熙皇帝", k:"羅漢腳", d:"限制漢人來台，導致台灣男多女少，社會動盪" },
        { s:"歷史", t:["國七","台灣史"], e:"林爽文事件", y:"1786", p:"林爽文", k:"天地會", d:"清領時期規模最大的民變，諸羅縣因此改名嘉義" },
        { s:"歷史", t:["國七","台灣史"], e:"開港通商", y:"1860", p:"英法聯軍", k:"茶、糖、樟腦", d:"台灣納入世界經濟體系，經濟重心由南轉北" },
        { s:"歷史", t:["國七","台灣史"], e:"牡丹社事件", y:"1874", p:"日本/沈葆楨", k:"開山撫番", d:"日本藉口琉球船民遇害犯台，清廷治台態度轉積極" },
        { s:"歷史", t:["國七","台灣史"], e:"中法戰爭", y:"1884", p:"劉銘傳", k:"台灣建省", d:"法軍攻打基隆淡水，戰後清廷宣布台灣建省" },
        { s:"歷史", t:["國七","台灣史"], e:"乙未戰爭", y:"1895", p:"唐景崧", k:"台灣民主國", d:"馬關條約割讓台灣，台灣人民自發性武裝抗日" },
        { s:"歷史", t:["國七","台灣史"], e:"噍吧哖事件", y:"1915", p:"余清芳", k:"西來庵", d:"日治時期規模最大的漢人武裝抗日，後轉為非武裝抗爭" },
        { s:"歷史", t:["國七","台灣史"], e:"霧社事件", y:"1930", p:"莫那魯道", k:"賽德克族", d:"原住民不滿日本高壓統治爆發的武裝抗爭" },
        { s:"歷史", t:["國七","台灣史"], e:"台灣議會設置請願", y:"1921-1934", p:"林獻堂", k:"台灣文化協會", d:"日治時期歷時最久的政治社會運動" },
        { s:"歷史", t:["國七","台灣史"], e:"皇民化運動", y:"1937", p:"小林躋造", k:"改姓名", d:"中日戰爭爆發，日本企圖將台灣人改造成日本人" },
        { s:"歷史", t:["國七","台灣史"], e:"二二八事件", y:"1947", p:"陳儀", k:"查緝私菸", d:"戰後初期因政治腐敗與文化衝突引發的嚴重流血事件" },
        { s:"歷史", t:["國七","台灣史"], e:"耕者有其田", y:"1953", p:"陳誠", k:"土地改革", d:"政府徵收地主土地放領給佃農，促進農業發展" },
        { s:"歷史", t:["國七","台灣史"], e:"美麗島事件", y:"1979", p:"施明德", k:"黨外運動", d:"人權日遊行遭鎮壓，審判過程喚起民眾民主意識" },
        { s:"歷史", t:["國七","台灣史"], e:"解嚴", y:"1987", p:"蔣經國", k:"開放黨禁報禁", d:"解除長達38年的戒嚴，台灣邁向民主憲政" },
        { s:"歷史", t:["國七","台灣史"], e:"野百合學運", y:"1990", p:"大學生", k:"廢除萬年國會", d:"台灣戰後最大規模學生運動，促成憲政改革" },
