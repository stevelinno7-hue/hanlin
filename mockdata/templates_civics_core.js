(function(global){
    ...
    function init() {
        ...
        const civDB = [
            ...
            { q: "家庭教導子女社會規範的過程稱為？", a: "社會化", o: ["教育", "撫養"], t: ["國七","社會"] },
            { q: "國家對內擁有最高統治權，對外獨立自主，是指？", a: "主權", o: ["政府", "領土"], t: ["國八","政治"] },
            { q: "行為時法律未規定者，不得處罰，這是？", a: "罪刑法定主義", o: ["無罪推定", "法律保留"], t: ["國八","法律"] },
            { q: "做出選擇時，所放棄的選項中價值最高者？", a: "機會成本", o: ["沉沒成本", "生產成本"], t: ["國九","經濟"] },
            { q: "國家權力行使手段損害最小，這是？", a: "比例原則", o: ["信賴保護", "法律優位"], t: ["高一","法律"] }
        ];

        G.registerTemplate('civ_basic', (ctx, rnd) => {
            const item = pick(civDB);
