(function(global){
    ...
    function init() {
        ...
        const bioDB = [
            ...
            // [國八] 生殖與遺傳
            { s:"生物", t:["國八","生殖"], q: "產生精子的器官", a: "睪丸" },
            { s:"生物", t:["國八","生殖"], q: "產生卵子的器官", a: "卵巢" },
            { s:"生物", t:["國八","生殖"], q: "胎兒發育的場所", a: "子宮" },
            { s:"生物", t:["國八","生殖"], q: "酵母菌的無性生殖方式", a: "出芽生殖" },
            { s:"生物", t:["國八","生殖"], q: "變形蟲的無性生殖方式", a: "分裂生殖" },
            { s:"生物", t:["國八","生殖"], q: "草莓/馬鈴薯的生殖方式", a: "營養器官繁殖" },
            { s:"生物", t:["國八","遺傳"], q: "遺傳學之父", a: "孟德爾" },
            { s:"生物", t:["國八","遺傳"], q: "控制性狀的特徵因子", a: "基因" },
            { s:"生物", t:["國八","遺傳"], q: "人類體細胞的染色體數目", a: "46條 (23對)" },
            { s:"生物", t:["國八","遺傳"], q: "人類精子/卵子的染色體數", a: "23條" },
            { s:"生物", t:["國八","遺傳"], q: "決定性別的染色體", a: "第23對 (性染色體)" },
            { s:"生物", t:["國八","演化"], q: "天擇說的提出者", a: "達爾文" },
            { s:"生物", t:["國八","演化"], q: "演化的最直接證據", a: "化石" },
            { s:"生物", t:["國八","演化"], q: "同源器官", a: "來源相同，功能可能不同" },
            { s:"生物", t:["國八","分類"], q: "生物分類的最高階層", a: "界" },
            { s:"生物", t:["國八","分類"], q: "生物學名的組成", a: "屬名 + 種小名" },
            { s:"生物", t:["國八","分類"], q: "藍綠菌屬於", a: "原核生物界" },
            { s:"生物", t:["國八","分類"], q: "黴菌/酵母菌屬於", a: "真菌界" },

            // [國八] 生態
            { s:"生物", t:["國八","生態"], q: "能量流動的方向", a: "單向流動" },
            { s:"生物", t:["國八","生態"], q: "物質循環的特性", a: "循環利用" },
            { s:"生物", t:["國八","生態"], q: "生產者", a: "綠色植物、藻類" },
            { s:"生物", t:["國八","生態"], q: "分解者", a: "細菌、真菌" },
            { s:"生物", t:["國八","生態"], q: "生物放大作用", a: "毒素在高級消費者累積" },
        ...
        G.registerTemplate('bio_concept', (ctx, rnd) => {
            ...
            // 智慧誘答：優先找同單元的錯誤選項
            const sameTag = bioDB.filter(x => x.t[1] === item.t[1] && x.a !== item.a);
            const others = bioDB.filter(x => x.a !== item.a);
            ...
            return {
                question: `【${item.t[1]}】${item.q}，是指下列何者？`,
                options: opts,
